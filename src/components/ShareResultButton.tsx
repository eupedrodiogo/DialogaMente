...
export const ShareResultButton = ({ result, totalQuestions }: ShareResultButtonProps) => {
  ...
  const shareText = `🎯 Meu Resultado ComunicaPro
...
✨ Descubra seu perfil comunicativo em ComunicaPro!`;
  ...
  const handleSharePDF = async () => {
    try {
      ...
      const pdfFile = new File([pdfBlob], "ComunicaPro-Resultado.pdf", { type: "application/pdf" });
      ...
      if (navigator.share && navigator.canShare?.({ files: [pdfFile] })) {
        ...
        a.href = url;
        a.download = "ComunicaPro-Resultado.pdf";
